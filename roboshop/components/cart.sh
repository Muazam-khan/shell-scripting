...
COMPONENT=cart
COMPONENT_URL="https://github.com/stans-robot-project/cart/archive/main.zip"
APPUSER="roboshop"
...
sed -i -e 's/REDIS_ENDPOINT/redis.roboshop.internal/' -e 's/CATALOGUE_ENDPOINT/catalogue.roboshop.internal/' ${APPUSER_HOME}/systemd.service #sed to replace mongo dns
