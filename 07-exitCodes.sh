...
# Among all,  0  represents that the action was completed successfully .
# Anything from 1 to 255 represents either partial succes, parital failure , complete failure
